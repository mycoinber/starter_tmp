...
<template>
  ...
  <PolicyTableOfContent v-if="data.sections && data.sections.length" :data="data" />

  <component v-if="data.sections" v-for="(item, index) in data.sections" :is="componentMap[item.type] || PolicySection"
    :key="index" :data="item" />
